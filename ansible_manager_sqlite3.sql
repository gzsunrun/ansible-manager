...
INSERT INTO `ansible_user` (user_id,user_account,user_password,created) VALUES ('2f8e409a-774c-440e-a281-3e21ef6467e0','admin', 'e10adc3949ba59abbe56e057f20f883e',datetime('now'));
ALTER TABLE `ansible_host`
ADD COLUMN `host_port`  int NULL DEFAULT 22;

ALTER TABLE `ansible_host`
ADD COLUMN `host_tag`  int NULL;

ALTER TABLE `ansible_repository`
ADD COLUMN `repo_version`  varchar(255) NULL;

ALTER TABLE `ansible_repository`
ADD COLUMN `repo_type`  varchar(255) NULL DEFAULT "ansible";
